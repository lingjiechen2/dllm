...
if [ "$instruct" = "True" ]; then
    ...
    accelerate launch --num_processes "${num_gpu}" dllm/pipelines/llada/eval.py \
        ...
        --model_args "pretrained=${model_name_or_path},max_new_tokens=512,steps=512,block_size=512,cfg=0.0,suppress_tokens=[],begin_suppress_tokens=[126081;126348]" --limit 20
