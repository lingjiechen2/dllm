...
MODEL_DIR_BASE="/mnt/lustrenew/mllm_aligned/shared/models/huggingface"
DATASET_DIR_BASE="/mnt/lustrenew/mllm_safety-shared/datasets/huggingface"
DATASET_DIR_BASE="/mnt/lustrenew/mllm_aligned/shared/datasets/huggingface"
