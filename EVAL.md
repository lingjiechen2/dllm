...
We provide a **unified evaluation framework** built on top of **[lm-evaluation-harness](https://github.com/EleutherAI/lm-evaluation-harness)**, serving as the standardized backbone for evaluating the [LLaDA series,](https://huggingface.co/GSAI-ML/LLaDA-8B-Base) [Dream series](https://huggingface.co/collections/Dream-org/dream-7b), and [BERT-diffusion series](https://huggingface.co/dllm-collection/ModernBERT-base-chat-v0).
